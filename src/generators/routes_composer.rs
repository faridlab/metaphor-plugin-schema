    ...
    fn generate_routes_mod(&self, schema: &ResolvedSchema) -> Result<String, GenerateError> {
        ...
        let imports: Vec<String> = routed_models
            ...
            .flat_map(|m| {
                ...
                vec![
                    format!("create_{}_routes", s),
                    format!("create_{}_read_routes", s),
                ]
            })
            .collect();
        ...
        writeln!(
            output,
            "/// Create stateless routes for the {} module.",
            pascal_name
        )
        .unwrap();
        writeln!(output, "///").unwrap();
        ...
        writeln!(
            output,
            "/// let module = {}Module::builder().with_database(pool).build()?;",
            pascal_name
        )
        .unwrap();
        ...
        writeln!(
            output,
            "pub fn create_stateless_routes(module: &crate::{}Module) -> Router<()> {{",
            pascal_name
        )
        .unwrap();
        ...
        writeln!(
            output,
            "pub fn create_readonly_{}_routes(module: &crate::{}Module) -> Router<()> {{",
        ...
        for model in &routed_models {
            ...
            writeln!(
                output,
                "        .merge(create_{}_read_routes(module.{}_service.clone()))",
        ...
        writeln!(
            output,
            "/// Get all routes (stateless) for the {} module.",
            pascal_name
        )
        .unwrap();
        writeln!(output, "///").unwrap();
        ...
        writeln!(
            output,
            "pub fn get_routes(module: &crate::{}Module) -> Router<()> {{",
            pascal_name
        )
        .unwrap();
        writeln!(output, "    Router::new()").unwrap();
        ...
        writeln!(
            output,
            "/// Create stateful routes for the {} module.",
            pascal_name
        )
        .unwrap();
        writeln!(output, "///").unwrap();
        ...
        writeln!(
            output,
            "pub fn create_combined_routes(module: &crate::{}Module) -> Router<AppState> {{",
            pascal_name
        )
        .unwrap();
        ...
        writeln!(
            output,
            "/// Get all routes (stateful) for the {} module.",
            pascal_name
        )
        .unwrap();
        writeln!(output, "///").unwrap();
        ...
        writeln!(
            output,
            "pub fn get_routes_with_state(module: &crate::{}Module) -> Router<AppState> {{",
            pascal_name
        )
        .unwrap();
        writeln!(output, "    Router::new()").unwrap();
